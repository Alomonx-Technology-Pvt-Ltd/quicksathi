/**
 * TiptoBook Client-Side Chat Fallback Engine
 * 
 * Ensures the chatbot NEVER stops working even if the backend server,
 * network connection, or external AI services are completely down.
 */
...
/**
 * Generate client-side fallback response
 */
export function getClientFallbackResponse(userText) {
  ...
  return `I'm happy to help you with **TiptoBook**! We connect you with top-rated local professionals across 6 categories:\n\n- **CCTV & Security** (Cameras, smart locks & repair)\n- **Car Rentals** (City, outstation & weddings with chauffeur)\n- **Weddings & Celebrations** (Photography, decor & catering)\n- **Home Salon & Beauty** (Hair, facials & makeup at home)\n- **House Help & Repairs** (Maids, cooks, electricians & plumbers)\n- **Home Tuition** (Verified tutors for class 1-12 & exam prep)\n\nWhich service would you like to explore or book?`;
}
