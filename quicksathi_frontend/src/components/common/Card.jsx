...
const Card = ({
  ...
  if (variant === "servicePreview") {
    return (
      <div
        className="w-full rounded-[18px] overflow-hidden border flex flex-col lg:flex-row transition-all duration-300 hover:-translate-y-1"
        style={{
          backgroundColor: "#F1EFE8",
          borderColor: "var(--color-border)",
        }}
      >
        <div className="flex lg:w-[40%] w-full gap-3 p-4 flex-shrink-0">
          <div
        ...
        <div className="flex-1 flex flex-col justify-center px-6 py-4 gap-3">
          <span
            className="text-[11px] font-semibold uppercase tracking-[0.18em] border rounded px-2.5 py-1 self-start"
            style={{
          ...
          <h2
            className="text-2xl leading-tight m-0"
            style={{
          ...
          <div className="flex items-center gap-2.5 mt-1">
            {linkTo && (
              <Link
                to={linkTo}
                className="text-[12px] font-semibold uppercase tracking-[0.08em] px-5 py-2.5 rounded-md no-underline transition-opacity duration-200 hover:opacity-80"
                style={{
                  fontFamily: "var(--font-body)",
            ...
            {secondaryAction && (
              <button
                className="text-[12px] uppercase tracking-[0.08em] px-5 py-2.5 rounded-md border transition-all duration-200"
                style={{
                  fontFamily: "var(--font-body)",
  ...
  if (variant === "classic") {
    return (
      <div
        className="rounded-[18px] overflow-hidden flex flex-col h-full border transition-all duration-300 hover:-translate-y-1"
        style={{
          backgroundColor: "#F1EFE8",
          borderColor: "var(--color-border)",
        }}
      >
        ...
        {/* Content */}
        <div className="flex flex-col flex-grow px-6 py-4 gap-3">
          <span
            className="text-[11px] font-semibold uppercase tracking-[0.18em] border rounded px-2.5 py-1 self-start"
            style={{
              fontFamily: "var(--font-body)",
          ...
          <p
            className="text-sm leading-relaxed m-0 flex-grow"
            style={{
              fontFamily: "var(--font-body)",
              color: "#888780",
              fontWeight: 400,
  ...
  const content = (
    <>
      ...
      <div className="absolute top-3 left-3 z-10">
        {primaryAction && (
          <span
            className="text-[11px] font-semibold uppercase tracking-[0.18em] border rounded px-2.5 py-1"
            style={{
              fontFamily: "var(--font-body)",
              color: "#F0997B",
              borderColor: "#993C1D",
      ...
      <div className="absolute bottom-0 left-0 right-0 p-4 z-10 flex flex-col gap-1.5">
        <h3
          className="font-normal text-xl leading-tight m-0"
          style={{
            fontFamily: "var(--font-display)",
            color: "#F1EFE8",
            letterSpacing: "-0.3px",
  ...
  if (linkTo) {
    return (
      <Link
        to={linkTo}
        className="group relative rounded-[18px] overflow-hidden block no-underline border transition-all duration-300 hover:-translate-y-1"
        style={{
          aspectRatio: "4/3",
          borderColor: "var(--color-border)",
  ...
  return (
    <div
      className="group relative rounded-[18px] overflow-hidden border transition-all duration-300 hover:-translate-y-1"
      style={{
        aspectRatio: "4/3",
        borderColor: "var(--color-border)",
        boxShadow: "0 4px 24px rgba(0,0,0,0.10)",
