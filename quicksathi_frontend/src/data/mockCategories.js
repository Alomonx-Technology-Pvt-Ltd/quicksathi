...
export const mockCategories = [
  {
    ...
    type: "SERVICE_ONLY",
    imageUrl: "/images/ac/ac-checkup.webp",
    ...
    subCategories: [
      {
        ...
        description: "AC check-up, deep foam jet service, cooling repair & maintenance.",
        vertical: "AC_APPLIANCES",
        type: "SERVICE_ONLY",
        imageUrl: "/icons/appliances/ac-repair.jpg",
        secondaryImageUrl: "/images/ac/foam-jet.webp",
        displayOrder: 1,
        active: true,
        parent: 1,
        subCategories: [],
      },
      {
        ...
        description: "Expert doorstep repair for front load, top load & semi-automatic machines.",
        vertical: "AC_APPLIANCES",
        type: "SERVICE_ONLY",
        imageUrl: "/icons/appliances/washing-machine.jpg",
        secondaryImageUrl: "/icons/appliances/washing-machine.jpg",
        displayOrder: 2,
        active: true,
        parent: 1,
        subCategories: [],
      },
      {
        ...
        description: "Doorstep fridge repair, gas refilling, compressor & cooling solutions.",
        vertical: "AC_APPLIANCES",
        type: "SERVICE_ONLY",
        imageUrl: "/icons/appliances/refrigerator.jpg",
        secondaryImageUrl: "/icons/appliances/refrigerator.jpg",
        displayOrder: 3,
        active: true,
        parent: 1,
        subCategories: [],
      },
      {
        ...
        description: "Smart TV repair, LED screen backlight fix, motherboard & wall mounting.",
        vertical: "AC_APPLIANCES",
        type: "SERVICE_ONLY",
        imageUrl: "/icons/appliances/tv-repair.jpg",
        secondaryImageUrl: "/icons/appliances/tv-repair.jpg",
        displayOrder: 4,
        active: true,
        parent: 1,
        subCategories: [],
      },
      {
        ...
        description: "Water heater repair, heating element replacement, descaling & installation.",
        vertical: "AC_APPLIANCES",
        type: "SERVICE_ONLY",
        imageUrl: "/icons/appliances/geyser-repair.jpg",
        secondaryImageUrl: "/icons/appliances/geyser-repair.jpg",
        displayOrder: 5,
        active: true,
        parent: 1,
        subCategories: [],
      },
      {
        ...
        vertical: "AC_APPLIANCES",
        type: "SERVICE_ONLY",
        imageUrl: "/images/ac/gas-refill.webp",
        secondaryImageUrl: "/images/ac/gas-refill.webp",
        displayOrder: 2,
        active: true,
        parent: 1,
        subCategories: [],
