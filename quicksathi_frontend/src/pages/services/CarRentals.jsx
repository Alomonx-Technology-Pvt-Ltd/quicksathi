    ...
    >
      ...
      >
        <div className="relative z-10 w-full px-6 sm:px-12 lg:px-16 pb-12 pt-28">
          ...
          <p
            className="text-white/55 text-sm sm:text-base mb-8"
              ...
              {FILTERS.map((f) => (
                <button
                  ...
                  style={{
                    ...
                    color:
                      activeFilter === f ? "#fff" : "var(--color-text-mid)",
                    borderColor:
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-10">
              ...
              >
                ...
                <div className="absolute bottom-6 left-6 right-6">
                  ...
                  <Link
                    to={featuredCar.link}
                    className="inline-block mt-4 px-6 py-2.5 rounded-xl text-sm font-semibold border-0 cursor-pointer no-underline transition-all duration-200 hover:opacity-90 text-center"
                    style={{
                      fontFamily: "var(--font-body)",
                      backgroundColor: "#1a3a6b",
                      color: "#fff",
              ...
              >
                ...
                <div className="absolute bottom-6 left-6 right-6">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Link
                      to={CARS[1].link}
                      className="w-10 h-10 rounded-full flex items-center justify-center border border-white/20 cursor-pointer hover:bg-white/10 transition-all no-underline"
                    >
