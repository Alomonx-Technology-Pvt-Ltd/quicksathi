...
const migrate = async () => {
  ...
  const acServicesSeed = [
    ...
    },
    {
      ...
      available: true,
      serviceMode: "AT_HOME",
      tags: ["AC", "Service", "Cleaning", "Maintenance", "Filter"],
      featured: true,
      packages: [
        {
          title: "Split AC Lite Service",
          price: 449,
          features: [
            "Filter cleaning",
      ...
      faqs: [
        {
          question: "How often should I get a lite service?",
          answer:
            "We recommend an AC lite service every 3-4 months for optimal cooling and energy efficiency.",
        },
        {
          question: "Do I need to provide any equipment?",
          answer:
            "No, the technician carries all necessary tools and cleaning solutions.",
        },
      ],
      reviews: [
        {
          ...
          rating: 5,
          comment:
            "AC is cooling much better after the service. Quick and clean work!",
        },
      ],
      providers: [
        {
    ...
    },
    {
      ...
      shortDescription:
        "Year-round AC care at discounted rates",
      fullDescription:
      ...
      available: true,
      serviceMode: "AT_HOME",
      tags: ["AC", "AMC", "Annual", "Maintenance", "Saver Pack"],
      featured: true,
      packages: [
        {
          title: "1 AC — Annual Pack",
          price: 1499,
          features: [
            "2 preventive services per year",
            "Free gas top-up (up to 200g)",
            "Priority scheduling",
            "10% off on any repairs",
          ],
        },
        {
          title: "2 AC — Annual Pack",
          price: 2699,
          features: [
            "2 services per AC per year (4 total)",
            "Free gas top-up (up to 200g each)",
            "Priority scheduling",
            "15% off on any repairs",
      ...
      faqs: [
        {
          question: "Can I cancel the AMC mid-year?",
          answer:
            "Yes, you can cancel anytime. A pro-rated refund will be issued for unused services.",
        },
        {
          question: "What is covered under the AMC?",
          answer:
            "Preventive servicing (filter clean, coil wash, gas check), free gas top-up, and discounted repairs for any breakdown.",
        },
      ],
      reviews: [
        {
          ...
          rating: 5,
          comment:
            "Best value for money. Both services were on time and AC runs perfectly all year.",
        },
      ],
      providers: [
        {
